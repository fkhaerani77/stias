...
export default function ExamInfoScreen() {
  ...
  const { history, categories, getQuestionsForCategory, getExamAccessStatus } =
    useExam();
  ...
  const completedExam = (history || []).find(
            ...
            {isCompleted ? (
              <View style={styles.completedRow}>
                ...
                <Text style={styles.completedText}>
                  Anda sudah menyelesaikan ujian ini (Score:{" "}
                  {completedExam.score}%)
                </Text>
              </View>
            ) : questionCount === 0 ? (
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({
                    pathname: "/mahasiswa/exam" as any,
